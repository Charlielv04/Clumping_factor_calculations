...
We first compare the gas clumping factors at redshift zero, using snapshot 099 and the native Voronoi-cell, volume-weighted calculation. Figures~\ref{fig:aida-l35-z0-clumping} and~\ref{fig:aida-l75-z0-clumping} show the absolute clumping factors as a function of the maximum overdensity defining the IGM, together with the relative difference from the CDM result,
$$
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/aida_tng_l35n1080_z0_gas_clumping.png}
    \caption{Gas clumping factors in the AIDA-TNG L35n1080 simulations at snapshot 099 ($z=0$), calculated directly from the native Voronoi cells. The upper panel shows the clumping factor as a function of the maximum overdensity threshold, while the lower panel shows $(C_{\rm CDM}-C_{\rm model})/C_{\rm CDM}$. The available models in this box are CDM, WDM3, and vSIDM.}
    \label{fig:aida-l35-z0-clumping}
\end{figure*}

\begin{figure*}[t]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/aida_tng_l75n910_z0_gas_clumping.png}
    \caption{Gas clumping factors in the AIDA-TNG L75n910 simulations at snapshot 099 ($z=0$), calculated directly from the native Voronoi cells. The upper panel shows the clumping factor as a function of the maximum overdensity threshold, while the lower panel shows $(C_{\rm CDM}-C_{\rm model})/C_{\rm CDM}$. The available models in this box are CDM, WDM3, SIDM1, and vSIDM.}
    \label{fig:aida-l75-z0-clumping}
\end{figure*}
...
snapshot at $z=5.49$ on a $512^3$ grid.  Bar heights give the median of three
