...
_SPECS = [
    ...
    _spec("alternative.ionized-sweep", "alternative", "Ionized-fraction threshold sweep", ("gas",), "native-cells", "volume", "ionized-fraction-cut", modes=("chunked", "pbs"), presets=("ionized-sweep",)),
    ...
    _spec("forest.lyman-alpha", "forest", "Lyman-alpha forest spectra", ("gas",), "line-of-sight", "column-density", "ray-selection", optional=("h5py",), presets=("lyman-alpha",)),
    _spec("forest.mfp", "forest", "Mean-free-path calculation", ("gas",), "line-of-sight", "optical-depth", "ray-selection", presets=("mfp",)),
    _spec("forest.gamma-hi", "forest", "Gamma_HI radiation model", ("gas",), "radiation-field", "volume", "ionizing-selection", presets=("gamma-hi", "gamma_hi")),
    _spec("forest.caches", "forest", "Forest and radiation cache artifacts", ("gas",), "cache", "n/a", "cache-key", presets=("forest-cache",)),
    _spec("forest.snapshot", "forest", "Snapshot workflow orchestration", ("gas",), "workflow", "method-defined", "workflow-selection", presets=("snapshot-workflow",)),
    ...
    _spec("thermodynamics.snapshot-temperature", "thermodynamics", "Snapshot temperature diagnostic", ("gas",), "snapshot-values", "volume", "temperature-selection", presets=("snapshot-temperature",)),
    _spec("diagnostics.density-ratio", "diagnostics", "Density-ratio diagnostic", ("gas", "dm", "both"), "derived-series", "method-defined", "selection-spec", presets=("density-ratio",)),
    _spec("diagnostics.equations", "diagnostics", "Equation 5-13 diagnostic suite", ("gas",), "derived-series", "method-defined", "selection-spec", presets=("equations", "eq5-13")),
