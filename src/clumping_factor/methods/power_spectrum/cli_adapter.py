...
def power_spectrum_main(argv: list[str] | None = None) -> None:
    from ...power_spectrum_cli import build_power_spectrum_parser
    ...
    print(f"Wrote power-spectrum JSON result: {compute(config, legacy_args=args)}")


def power_spectrum_plot_main(argv: list[str] | None = None) -> None:
    from ...power_spectrum_plotting import power_spectrum_plot_main as legacy_main

    return legacy_main(argv)


def power_spectrum_compare_main(argv: list[str] | None = None) -> None:
    from ...power_spectrum_plotting import power_spectrum_compare_main as legacy_main
