...
env_vars="PROJECT_DIR=${project_dir},SNAPSHOT=${SNAPSHOT},BASE_PATH=${BASE_PATH},MFP_FILE=${MFP_FILE},COMPUTE_MISSING_IONIZING=${COMPUTE_MISSING_IONIZING},MFP_LOS_FILE=${MFP_LOS_FILE},MFP_STARTS_PER_RAY=${MFP_STARTS_PER_RAY},MFP_SEED=${MFP_SEED},GAMMA_HI_THRESHOLD=${GAMMA_HI_THRESHOLD},SIGMA_HI_CM2=${SIGMA_HI_CM2},SIMULATION_NAME=${SIMULATION_NAME},OUTPUT_DIR=${OUTPUT_DIR},OUTPUT=${OUTPUT},CONDA_ENV=${CONDA_ENV},GAMMA_HI_FILE=${GAMMA_HI_FILE},TEMPERATURE_FILE=${TEMPERATURE_FILE},REDUCED_SPEED_OF_LIGHT_FRACTION=${REDUCED_SPEED_OF_LIGHT_FRACTION},C_TILDE_CM_S=${C_TILDE_CM_S},PHOTON_GROUPS_CSV=${photon_groups_csv},PHOTON_GROUP_TESTS_CSV=${photon_group_tests_csv},THRESHOLDS_CSV=${thresholds_csv},THRESHOLD_MIN=${THRESHOLD_MIN},THRESHOLD_MAX=${THRESHOLD_MAX},THRESHOLD_COUNT=${THRESHOLD_COUNT},IONIZED_DENSITY_THRESHOLDS_CSV=${ionized_density_thresholds_csv},IONIZED_CUTS_CSV=${ionized_cuts_csv},IONIZED_SWEEP=${IONIZED_SWEEP},IONIZED_CUT_MIN=${IONIZED_CUT_MIN},IONIZED_CUT_MAX=${IONIZED_CUT_MAX},IONIZED_CUT_COUNT=${IONIZED_CUT_COUNT},CHUNK_SIZE=${CHUNK_SIZE},HYDROGEN_MASS_FRACTION=${HYDROGEN_MASS_FRACTION},CHI_E=${CHI_E},PROGRESS_INTERVAL=${PROGRESS_INTERVAL},VERBOSE=${VERBOSE}"
